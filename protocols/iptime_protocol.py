    ...
    HEADER = MessageSpec(
        ...
        fields=[
            ...
            FieldSpec(
                ...
                compute_func=_calculate_iptime_checksum
            ),
        ]
    )
...
{args_xml}    </u:{action}>
    ...
    @classmethod
    def generate_add_port_mapping(cls,
