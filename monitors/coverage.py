...
class QEMUCoverageCollector:
    ...
    def run_with_coverage(self, 
                          input_data: bytes,
                          stdin_input: bool = True) -> CoverageResult:
        """
...
# 팩토리 함수
def create_coverage_collector(arch: str = "mipsel",
                              binary_path: str = None,
                              libs_path: str = None) -> QEMUCoverageCollector:
    """커버리지 수집기 생성"""
    qemu_map = {
        'mipsel': 'qemu-mipsel',
        'mips': 'qemu-mips',
